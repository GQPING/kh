...
<div>
    <nav class="breadcrumb">
        ...
        <span class="c-gray en">&gt;</span> 项目回款明细
...
<script type="text/javascript">
    ...
    function submitAction(time){
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath }/project/searchSummary2",
            data:{time : time, type:"出售"},
            async: false,
